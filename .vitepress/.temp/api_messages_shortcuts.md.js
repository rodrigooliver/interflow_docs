...
const __pageData = JSON.parse('{"title":"Atalhos e sequências","description":"","frontmatter":{},"headers":[],"relativePath":"api/messages/shortcuts.md","filePath":"api/messages/shortcuts.md","lastUpdated":1784707561000}');
const _sfc_main = { name: "api/messages/shortcuts.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("api/messages/shortcuts.md");
