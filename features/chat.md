...
Ferramentas do dia a dia do atendente: inbox, atalhos, tags, encerramento e campanhas.

## Destaques

- [Interface de chat](/guide/chat/interface) unificada
- [Disparos em massa](/guide/chat/bulk-messages) (mensagem, fluxo ou fluxo silencioso)
...
- [Tipos de encerramento](/guide/chat/closure-types)
