...
| [2026.5.1](/en/changelog/2026/05/2026.5.1) | 05/22 | **WhatsApp group closing** — same flow as individual conversations; Resolve button, closure type, summary and reopen |
...
- **WhatsApp group closing** (v2026.5.1) — groups now use the same closing flow as individual conversations; Resolve button at the top of the chat (or ⋮ menu on mobile); closure type and summary; removed from unread list; one-click reopen
