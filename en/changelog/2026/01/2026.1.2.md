...
- ✅ **Enhanced security**: Agents with `agent_limited` permission view only customers related to their own services
- ✅ **Data privacy**: Prevents agents from accessing information about customers not assigned to them
