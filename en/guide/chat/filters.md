...
| **Export report** | Applies the same cut to the export |
...
- Text, number, and yes/no fields — they do not filter the list yet
- Extra columns for those fields in the report file — the cut applies; exportable columns remain on the roadmap
