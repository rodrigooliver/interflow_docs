...
1. **Configure sua primeira campanha**: Menu UTM → Campanhas
2. **Adicione o ID da Campanha do Facebook**: Ex: `120233174044090606`
3. **Configure o Pixel**: ID + Token de Acesso
4. **Configure eventos nos estágios**: CRM → Gerenciar Estágios
5. **Teste**: Mova um cliente que veio de anúncio para outro estágio
6. **Verifique**: Gerenciador de Eventos do Facebook
