...
Actualizaciones del mes de mayo de 2026.

## Versiones

| Versión | Fecha | Destacados |
|---------|-------|------------|
| [2026.5.6](/es/changelog/2026/05/2026.5.6) | 29/05 | **Eliminación masiva con opción de borrar chats** — admin/owner puede eliminar chats vinculados al borrar clientes en lote; selector de 10 o 50 clientes por página |
...
| [2026.5.1](/es/changelog/2026/05/2026.5.1) | 22/05 | **Cierre de grupos de WhatsApp** — mismo flujo que conversaciones individuales; botón Resolver, tipo de cierre, resumen y reapertura |
...
- **Eliminación masiva con opción de eliminar chats vinculados** (v2026.5.6) — al eliminar clientes en lote, admin/owner puede marcar una opción para borrar todos los chats, mensajes y archivos vinculados; archivos eliminados mediante cola asíncrona; selector de 10 o 50 clientes por página en la lista
...
- **Cierre de grupos de WhatsApp** (v2026.5.1) — los grupos usan el mismo flujo de cierre que las conversaciones individuales; botón Resolver en la parte superior (o menú ⋮ en móvil); tipo de cierre y resumen; eliminación de la lista de no leídos; reapertura con un clic
