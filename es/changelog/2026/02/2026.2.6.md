...
1. **Configure su primera campaña**: Menú UTM → Campañas
2. **Agregue el ID de Campaña de Facebook**: Ej: `120233174044090606`
3. **Configure el Píxel**: ID + Token de Acceso
4. **Configure eventos en etapas**: CRM → Administrar Etapas
5. **Pruebe**: Mueva un cliente que vino de anuncio a otra etapa
6. **Verifique**: Administrador de Eventos de Facebook
